    ...
    <div class="left-column-wrapper">
      <div class="title">
        <h2 class="headline-large">
          .we can <span class="color-variant">help<br /></span>_
          <span class="color-variant">you</span> with...
        </h2>
      </div>
    </div>
    <div class="rigth-column-wrapper">
      <div class="service1">
...
<style type="scss">
  .color-variant {
    color: var(--md-ref-palette-primary4);
  }
  .top-content-wrapper {
    display: grid;
